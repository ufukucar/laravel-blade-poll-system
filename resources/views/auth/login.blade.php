...
<head>
    ...
    <title>LARAVEL POLL LOGIN</title>
    ...
    <div class="container mx-auto p-8  h-full w-full grid  h-screen place-items-center">
        ...
        <div class="mx-auto my-auto max-w-md sm:min-w-[32rem]  ">
            ...
            <div class="bg-white   border rounded-xl shadow-lg shadow-gray-500">
                ...
                <form class="bg-grey-lightest p-5 " action="{{ route('login') }}" method="POST">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <a href="{{ route('register') }}" class="font-semibold text-md text-primary hover:text-primary-dark no-underline">Register</a>
